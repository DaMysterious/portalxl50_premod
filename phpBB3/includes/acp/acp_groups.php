...
class acp_groups
{
	...
	function main($id, $mode)
	{
		...
		$scheduled = request_var('schedule', 0);
		...
		switch ($action)
		{
			...
			case 'list':
				...
				//BEGIN - Scheduled Group Membership
				sgm_template_append($template, $row, 'leader');
				//END - Scheduled Group Membership					
				}
				$db->sql_freeresult($result);
				...
				$template->assign_vars(array(
					...
					'HOURS_SCHEDULING'		=> hours_dropdown(),
					'MINUTES_SCHEDULING' 	=> minutes_dropdown(),
					'DAYS_SCHEDULING'		=> days_dropdown(),
					'MONTHS_SCHEDULING'		=> months_dropdown(),
					'YEARS_SCHEDULING'		=> years_dropdown(),					
				));
				...
				//BEGIN - Scheduled Group Membership
				sgm_template_append($template, $row, 'member');
				//END - Scheduled Group Membership
				}
				$db->sql_freeresult($result);
