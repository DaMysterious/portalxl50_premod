...
class phpbb_gallery_config
{
	...
	*/
	...
	static public function load($load_default = false)
	{
		...
		global $phpbb_seo;
		if (!empty($phpbb_seo)) {
			$phpbb_seo->phpbb_filter['album']['album'] = array('sk' => self::$config['default_sort_key'], 'sd' => self::$config['default_sort_dir'], 'st' => 0);
			$phpbb_seo->phpbb_filter['album']['pic'] = array('sk' => self::$config['default_sort_key'], 'sd' => self::$config['default_sort_dir'], 'st' => 0, 'sort_order' => 'ASC');
			$phpbb_seo->phpbb_filter['album']['search'] = array('sk' => self::$config['default_sort_key'], 'sd' => self::$config['default_sort_dir'], 'st' => 0, 'terms' => 'all');
		}
