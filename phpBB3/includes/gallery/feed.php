	...
	*/
	...
	public function send_images()
	{
		...
		foreach ($this->images_data as $image_id => $row)
		{
			...
			// www.phpBB-SEO.com SEO TOOLKIT BEGIN
			$phpbb_seo->prepare_url('pic', $row['image_name'], $image_id, $phpbb_seo->seo_url['album'][$row['image_album_id']]);
			//$u_thumbnail = phpbb_gallery_url::append_sid('full', 'image', 'mode=thumbnail&album_id=' . $row['image_album_id'] . '&image_id=' . $image_id);
			$u_thumbnail = phpbb_gallery_url::append_sid('image', 'mode=thumbnail&album_id=' . $row['image_album_id'] . '&image_id=' . $image_id, true, '');
			//$url_imagepage = phpbb_gallery_url::append_sid('full', 'image_page', 'album_id=' . $row['image_album_id'] . '&image_id=' . $image_id);
			$url_imagepage = phpbb_gallery_url::append_sid('image_page', 'album_id=' . $row['image_album_id'] . '&image_id=' . $image_id, true, '');
			//$url_fullsize = phpbb_gallery_url::append_sid('full', 'image', 'album_id=' . $row['image_album_id'] . '&image_id=' . $image_id);
			$url_fullsize = phpbb_gallery_url::append_sid('image', 'album_id=' . $row['image_album_id'] . '&image_id=' . $image_id, true, '');
			// www.phpBB-SEO.com SEO TOOLKIT END
			...
			{
				// www.phpBB-SEO.com SEO TOOLKIT BEGIN
				$phpbb_seo->set_user_url( $row['image_username'], $row['image_user_id'] );
				// www.phpBB-SEO.com SEO TOOLKIT END
