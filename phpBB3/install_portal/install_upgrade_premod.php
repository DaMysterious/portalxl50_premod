	...
	function update_data($sub)
	{
		...
		switch($portal_version)
		{
			...
			case 'Plain 0.2':
				...
				$sql[] = "INSERT INTO " . PORTAL_MODS_TABLE . " (mod_id, mod_title, mod_version, mod_version_type, mod_desc, mod_url, mod_author, mod_download) VALUES (21, 'Download Mod for phpBB 3', '6.5.25', '', 'This mod generates a page of downloads for your phpBB 3 forum.', 'http://phpbb3.oxpus.net/index.php', 'OXPUS', 'http://phpbb3.oxpus.net/downloads.php?view=detail&amp;df_id=1')";
				...
				$sql[] = "INSERT INTO " . CONFIG_TABLE . " (config_name, config_value, is_dynamic) VALUES ('dl_mod_version', '6.5.25', 0)";
