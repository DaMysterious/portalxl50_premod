...
$template->assign_vars(array(
	...
	'NEWEST_PGALLERIES'	=> ($total_pgalleries) ? sprintf($user->lang['NEWEST_PGALLERY'], get_username_string('full', phpbb_gallery_config::get('newest_pega_user_id'), phpbb_gallery_config::get('newest_pega_username'), phpbb_gallery_config::get('newest_pega_user_colour'), '', phpbb_gallery_url::path('gallery') . "album.$phpEx?album_id=". phpbb_gallery_config::get('newest_pega_album_id'))) : '',
	// www.phpBB-SEO.com SEO TOOLKIT END
	...
	'U_USERS_PERSONAL_GALLERIES'	=> ($_u_perso = (phpbb_gallery::$auth->acl_check('a_list', phpbb_gallery_auth::PERSONAL_ALBUM)) ? phpbb_gallery_url::append_sid('index', 'mode=personal') : ''),
	'U_USERS_PERSONAL_GALLERIES_QMFIX' =>  $_u_perso . (strpos($_u_perso, '?') === false ? '?' : ''),
	// www.phpBB-SEO.com SEO TOOLKIT END
