...
if ($submit || $preview || $refresh)
{
	...
	// Start Breizh Shoutbox
	$post_data['hide_robot']		= (isset($_POST['hide_robot'])) ? true : false;
	// End Breizh Shoutbox
	...
	if (!sizeof($error) && $submit)
	{
		...
		if ($submit)
		{
			...
			$data = array(
				...
				// Mod browser, os & screen
				'post_ua'				=> $user->data['session_browser'],
				'screen'				=> (string) $screen,
				// End Mod browser, os & screen

				// Start Breizh Shoutbox
				'hide_robot'			=> (bool) $post_data['hide_robot'],
				// End Breizh Shoutbox
...
// Start Breizh Shoutbox
$shout_hide_checked	= $post_data['hide_robot'];
// End Breizh Shoutbox
...
// Start Breizh Shoutbox
$s_hide_robot = true; // !important
$exclude_forums = array();
if ($config['shout_exclude_forums'])
{
	$exclude_forums = explode(',', $config['shout_exclude_forums']);
...
//	'MESSAGE'				=> $post_data['post_text'],
	...
	// Start Breizh Shoutbox
	'S_SHOUT_HIDE_CHECKED'		=> ($shout_hide_checked) ? ' checked="checked"' : '',
	'S_SHOUT_HIDE_ALLOWED'		=> ($auth->acl_get('u_shout_hide') && $s_hide_robot) ? (($mode == 'edit' && !$config['shout_edit_robot'] && !$config['shout_edit_robot_priv']) ? false : true) : false,
	// End Breizh Shoutbox
