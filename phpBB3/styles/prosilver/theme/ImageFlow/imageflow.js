...
domReady(function()
{
	...
	instanceOne.init({ ImageFlowID:'cpg_imageflow',
		  preloadImages: true, /* Toggles loading bar (false: requires img attributes height and width) */
		  ...
		  /* opacityArray: [4,3,2,1,1], */  /* Image opacity (range: 0 to 10) first value is for the focussed image */
		  startAnimation: true, /* Animate images moving in from the right on startup */
		  xStep: 200, /* Step width on the x-axis in px */
		  imageFocusM: 1.6, /* Multiplicator for the focussed image size in percent */
		  startID: 5,
