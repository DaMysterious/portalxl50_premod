...
* @version $Id: arcade_game_jackpot.php,v 1.0 2009/11/15 portalxl group Exp $
*
...
{
	include_once($phpbb_root_path . 'arcade/includes/common.' . $phpEx);
	include_once($phpbb_root_path . 'arcade/includes/constants.' . $phpEx);
}
...
$number_of_game_jackpot = $arcade_config['stat_items_per_page'];
