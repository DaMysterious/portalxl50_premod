...
*
* @package arcade
* @version $Id: constants.php 1663 2011-09-22 12:09:30Z killbill $
...
define('ARCADE_VERSION', '2.0.RC1');

define('ARCADE_ERROR_UNKNOWN', 0);
define('ARCADE_ERROR_GAMETYPE', 1);
define('ARCADE_ERROR_TIME', 2);
define('ARCADE_ERROR_FILEMISSING', 3);
...
define('ARCADE_UCP_GAMES_PER_PAGE_MIN', 0);
define('ARCADE_UCP_GAMES_PER_PAGE_MAX', 50);

define('ARCADE_FREE', -1);
define('ARCADE_CASH_MOD', 1);
define('ARCADE_POINTS_SYSTEM', 2);
define('ARCADE_SIMPLE_POINTS_SYSTEM', 3);
define('ARCADE_ULTIMATE_POINTS_SYSTEM', 4);
