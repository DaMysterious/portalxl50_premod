...
*
* @package arcade
* @version $Id: auth_admin.php 1663 2011-09-22 12:09:30Z killbill $
	...
	*/
	function get_mask($mode, $user_id = false, $group_id = false, $cat_id = false, $auth_option = false, $scope = false, $acl_fill = ACL_NEVER)
	{
		...
		if ($view_user_mask)
		{
			...
			$sql = 'SELECT u.user_id, a.user_arcade_permissions, u.user_type
				FROM ' . USERS_TABLE . ' u, ' . ARCADE_USERS_TABLE . ' a
				WHERE u.user_id = a.user_id
					AND ' . $db->sql_in_set('u.user_id', $ug_id);
			$result = $db->sql_query($sql);
