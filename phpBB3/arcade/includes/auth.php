...
*
* @package arcade
* @version $Id: auth.php 1663 2011-09-22 12:09:30Z killbill $
...
class auth_arcade
{
	...
	*/
	function acl(&$userdata)
	{
		...
		foreach ($this->acl as $cat_id => $bitstring)
		{
			if (($cat_id && strlen($bitstring) != $local_length) || (!$cat_id && strlen($bitstring) != $global_length))
			{
				$renew = true;
				break;
			}
